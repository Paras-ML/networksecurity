...
"""
defining commom constant variable for the training pipeline
"""
...
DATA_INGESTION_DATABASE_NAME: str = "ParasAI"
...
MODEL_TRAINER_TRAINED_EXPECTED_SCORE:float = 0.6
MODEL_TRAINER_OVER_FITTING_UNDER_FITTING_THRESHOLD:float= 0.05


TRAINING_BUCKET_NAME = "parasnetworksecurity"