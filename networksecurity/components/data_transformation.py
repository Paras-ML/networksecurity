...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        """
        It initialise the KNNImputer object with the parameters specified in the training_pipeline.py file
        ...
        try:
            ...
            logging.info(f"Initialse KNNImputer with {DATA_TRANSFORMATION_IMPUTER_PARAMS}")
